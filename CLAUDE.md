...
Claude agents working in this repository must follow these rules.
...
Read [AI_DATABASE_CHANGE_REQUIREMENTS.md](./AI_DATABASE_CHANGE_REQUIREMENTS.md) before database, entity, repository, service, controller, or module changes.
